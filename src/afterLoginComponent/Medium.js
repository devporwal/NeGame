...
export default function Medium() {
    ...
    const [hintvalue,sethintvalue] = useState("Hints: (1)")
      ...
      async function Play(){
          ...
          if(val.length <3){
              ...
              var url = "https://ne-games.com/ne_lite/api/level_two?search=" + val.toLowerCase();
              ...
              .then((response) => {
                  ...
                  if (response.status === 200 && response.message === "Success") {
                      ...
                      url = "https://ne-games.com/ne_lite/api/level_two?search=" +passvalue;
                      fetch(url,{
                          headers: myHeaders
                      }).then((response) => response.json())
                      .then((response) => {
              ...
              let url = "https://ne-games.com/ne_lite/api/level_two?search=" + val.toLowerCase();
              console.log(val.toLowerCase(), url);
              ...
              wordFinder.then(async (result)=>{
                  ...
                  if(result.status === 200 && result.message === "Success" ){
                    ...
                    if(val.toLowerCase() === laststore.toLowerCase()){
                      ...
                      const url = "https://ne-games.com/ne_lite/api/level_two?search=" + passvalue;
                      console.log("concede",val.toLowerCase(), url);
                      myHeaders = new Headers();
                      myHeaders.append(
                      'APPKEY',
  ...
  <div className='easybg_image'>
    ...
    <div className='' style={{float:' right'}} ><img src={require('../assets/images/newdashsetting.png')} className="extbtn" alt="..."/> </div>
                    ...
                    <button  className='hintbtbleft' onClick={Left} style={{backgroundColor:leftcolor}}><i className="fas fa-chevron-left"></i> </button>
                    <button className='hintbtbright'  onClick={Right} style={{backgroundColor:rightcolor}}><i className="fas fa-chevron-right"></i> </button>
                    </div>
